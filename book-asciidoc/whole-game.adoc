...
....
#> ✔ Creating '/tmp/RtmpsvCDVC/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpsvCDVC/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8b6a50f530… |howardbaik howardbaik@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpsvCDVC/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpsvCDVC/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpsvCDVC/regexcite/README.Rmd'
----
